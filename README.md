...
🕒 **Uptime**: 23 years, 5 months, 10 days  
💼 **Current Role**: Data Analyst | Machine Learning Engineer  
🏢 **Organization**: Purdue University (MSCS)  
🛠 **IDE**: VSCode, PyCharm, Jupyter Notebook  
📂 **Kernel**: Linux 5.15.0-79  
...
#### 🌐 **Web & Databases**
`React.js` `Django` `Node.js` `MongoDB`  
#### 📊 **Data Science & AI**
`TensorFlow` `PyTorch` `Scikit-learn` `YOLOv5`  
#### ☁ **Cloud & DevOps**
`AWS` `Docker` `Kubernetes`  

---
### **🛠 Hobbies & Interests**
🕹️ **Gaming**: Minecraft Modding, AI Bots  
🖥️ **Hardware**: Overclocking, Linux Customization  
🔬 **Research**: AI Ethics, NLP Models  

---
### **📩 Contact Me**
📧 **Email (Personal)**: [parthsamirdalvi@gmail.com](mailto:parthsamirdalvi@gmail.com)  
📧 **Email (Work)**: [dalvi@purdue.edu](mailto:dalvi@purdue.edu)  
🔗 **LinkedIn**: [linkedin.com/in/parthdalvi04](https://www.linkedin.com/in/parthdalvi04)  
💻 **GitHub**: [github.com/Parth04Dalvi](https://github.com/Parth04Dalvi)  
💬 **Discord**: ParthDalvi#1234  

---
### **📊 GitHub Stats**
🏆 **Repositories**: `7` (**Contributed**: `X`)  
⭐ **Stars**: `X`  
🔧 **Commits**: `X`  
👥 **Followers**: `X`  
📊 **Lines of Code**: `X` (**Y+**, **Z-**)  
...
---
👀 **Fun Fact**: I automate everything. If it’s repetitive, I script it. 🚀
